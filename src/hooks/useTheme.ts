...
export type Theme = "charcoal" | "forest-dark" | "sage-light" | "ocean-blue" | "warm-amber" | "slate-night";
...
export function initTheme(): void {
  ...
  applyTheme(saved ?? "charcoal");
}

export function useTheme() {
  const [theme, setThemeState] = useState<Theme>(() => {
    return (localStorage.getItem(STORAGE_KEY) as Theme) ?? "charcoal";
  });
